...
public class SVGDrawable extends PictureDrawable {
    ...
    public int getIntrinsicWidth() {
        return (int) (getPicture().getWidth() / SVG.MULTIPLIER * ApplicationAccess.INSTANCE.getDip());
    }

    @Override
    public int getIntrinsicHeight() {
        return (int) (getPicture().getHeight() / SVG.MULTIPLIER * ApplicationAccess.INSTANCE.getDip());
    }
